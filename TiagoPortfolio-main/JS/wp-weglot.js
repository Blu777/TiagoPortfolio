  ...
  function (e, t) {
    function o() {
      ...
      Array.prototype.forEach.call(e, function (e, t) {
        ...
        o && n
          ? (o.insertBefore(e, n),
            e.classList.remove("weglot-custom-switcher-ajax"))
          : o
    ...
    "loading" === document.readyState
      ...
      document.addEventListener("DOMContentLoaded", function (e) {
        ...
        window.getComputedStyle(t).getPropertyValue("bottom"),
          window.getComputedStyle(t).getPropertyValue("top");
        if (
          ((("fixed" !== c && o > l / 2) || ("fixed" === c && o > 100)) &&
            (t.className += " weglot-invert"),
          (function () {
            try {
        ...
        if (s.length > 0) {
          ...
          for (let t of s) {
            const o = { ENTER: 13, ESCAPE: 27, ARROWUP: 38, ARROWDOWN: 40 },
              n = () => {
                const { bottom: e = 0 } = t.getBoundingClientRect();
                return e > window.innerHeight / 2;
              },
              r = () => {
                t.classList.remove("closed"),
                  (document.querySelectorAll(
                    ".country-selector.weglot-dropdown input"
                  ).checked = !0),
              ...
              l = () => {
                t.classList.add("closed"),
                  ...
                  u && (u.classList.remove("focus"), (u = null));
              },
              c = (e) => {
                getLangNameFromCode(e);
                t.setAttribute("aria-activedescendant", "weglot-language-" + e),
                  t.setAttribute("aria-label", "Language selected: " + e);
              },
              s = () => {
                t.classList.contains("closed") ? r() : l(),
                  u && u.classList.remove("focus"),
                  (u = null);
              };
            t.addEventListener("keydown", (n) => {
              if (n.keyCode !== o.ENTER) {
                if (n.keyCode === o.ARROWDOWN || n.keyCode === o.ARROWUP)
                  return n.preventDefault(), void a(n.keyCode);
                n.keyCode === o.ESCAPE &&
                  i(t) &&
                  (n.preventDefault(), l(), t.focus());
              } else {
              ...
              if (u && i(t))
                u[s]
                  ? (u.classList.remove("focus"),
                    (u = u[s]),
                    u.classList.add("focus"),
                    u.childNodes[0].focus(),
                    u.scrollIntoView({ block: "center" }))
                  : ((c === o.ARROWUP && !a) || (c === o.ARROWDOWN && a)) &&
                    (l(), t.focus());
              else {
                const n = a ? "ul li.wg-li:last-child" : "ul li.wg-li";
                for (var d = 0; d < e.length; d++)
                  u = e[d].parentNode.querySelector(n);
                if (!u) return;
                u.classList.add("focus"),
                  u.childNodes[0].focus(),
                  u.scrollIntoView({ block: "center" });
